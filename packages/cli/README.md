...
[![npm version](https://img.shields.io/npm/v/@cosmjs-rn/cli.svg)](https://www.npmjs.com/package/@cosmjs-rn/cli)
...
```
$ npm install @cosmjs-rn/cli --save-dev
$ ./node_modules/.bin/cosmwasm-cli
```
...
```
$ npm install -g @cosmjs-rn/cli
$ cosmwasm-cli
```

## Getting started

1. Install `@cosmjs-rn/cli` and run `cosmwasm-cli` as shown above
